...
public class EstudiantePresencial extends Estudiante {
    ...
    public EstudiantePresencial(String n, String ap, String iden, int e, double 
            numCredito,double costoCredit){
        super(n, ap, iden, e);
        numeroCreditos=(int) numCredito;
        costoCredito =costoCredit;
    }
